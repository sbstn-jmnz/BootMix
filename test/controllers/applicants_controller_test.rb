...
class ApplicantsControllerTest < ActionController::TestCase
  ...
  test "should create applicant" do
    assert_difference('Applicant.count') do
      post :create, applicant: { email: @applicant.email, lastname: @applicant.lastname, name: @applicant.name, phone: @applicant.phone }
    end
  ...
  test "should update applicant" do
    patch :update, id: @applicant, applicant: { email: @applicant.email, lastname: @applicant.lastname, name: @applicant.name, phone: @applicant.phone }
    assert_redirected_to applicant_path(assigns(:applicant))
  end
